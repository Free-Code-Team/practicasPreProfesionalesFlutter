...
class PracticaHomeEstudiante extends StatefulWidget {
  const PracticaHomeEstudiante({Key? key}) : super(key: key);

  @override
  State<PracticaHomeEstudiante> createState() => _PracticaHomeEstudiante();
}

class _PracticaHomeEstudiante extends State<PracticaHomeEstudiante> {
